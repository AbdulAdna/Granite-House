...
namespace GraniteHouse.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> CreatePost()
        {
            ...
            var productsFormDb = _db.Products.Find(ProductsVM.Products.Id);
            ...
            if (files.Count > 0)
            {
                ...
                productsFormDb.Image = @"\" + SD.ImageFolder + @"\" + ProductsVM.Products.Id + extension;
            }
            else
            {
                ...
                productsFormDb.Image = @"\" + SD.ImageFolder + @"\" + ProductsVM.Products.Id + ".png";
            }
            await _db.SaveChangesAsync();
